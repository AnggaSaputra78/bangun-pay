...
const Placeholder = ({ title }) => (
  <div className="card text-center py-12">
    ...
    <p className="text-gray-500 dark:text-gray-400">Fitur ini sedang dalam pengembangan</p>
  </div>
)
...
const NotFound = () => (
  <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-navy-900">
    <div className="text-center">
      ...
      <a href="/dashboard" className="btn btn-primary">Kembali ke Dashboard</a>
    </div>
  </div>
)
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/projects" element={<Placeholder title="Manajemen Proyek" />} />
